...
class EditColorDialogBox extends StatelessWidget {
  int colorIndex;
  Function handleColorSelection;
  int colorsLength;
  List<Color> colors;
  EditColorDialogBox({super.key, required this.colorIndex, required this.handleColorSelection, required this.colorsLength, required this.colors});
